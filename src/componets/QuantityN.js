...
function Ouantity({ }) {
    ...
    return (
        <>
            <div className="QuantityN">
                <div className="quickOption" onClick={showPayModal}>
                    <span className="QntyN" > Quantity</span>
                </div>
            </div>
            <Modal
                title="Order Shipped"
                ...
                cancelText="Cancel"
            >
                <p>Enter the quantity of product to be received by Buyer</p>
                <Input
                    type="text"
                    placeholder="Nos"
                    value={Nos}
