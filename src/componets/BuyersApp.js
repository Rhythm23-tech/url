...
function BuyersApp({ }) {
    const [BuyersApproval, setBuyersApproval] = useState("");
        ...
        <>
            <div className="AppB">
                <div className="quickOption" onClick={showPayModal}>
                    <span className="BA" > Approval </span>
                </div>
            </div>
            <Modal
                title="Approval"
            ...
            >
                ...
                <Input
                    ...
                    value={BuyersApproval}
                    onChange={(e) => setBuyersApproval(e.target.value)}
