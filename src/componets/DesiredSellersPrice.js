...
function DesiredSellersPrice({ }) {
    ...
    const { config } = usePrepareContractWrite({
        ...
        abi: ABI,
        functionName: "NetPriceOfdefectivepieces",
        args: [desiredprice],
    });
    ...
    return (
        <>
            <div className="DesiredSellersprice">
                <div className="quickOption" onClick={showPayModal}>
                    <span className="DSP" >Desired Price</span>
                </div>
            </div>
            <Modal
            ...
            >
                ...
                <Input
                    type="number"
                    placeholder="PS: Amount enter by seller and buyer should be same"
                    value={desiredprice}
...
export default DesiredSellersPrice;